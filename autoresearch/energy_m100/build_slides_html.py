...
.slide.dark{background:#1E2961;color:#fff}
.slide.cover{background:#1E2961;color:#fff;justify-content:center;align-items:flex-start}
h2{font-size:2.1vw;color:#065A82;font-weight:700;margin-bottom:2.5vh;line-height:1.35;border-left:.5vw solid #028090;padding-left:1vw}
h2 .n{display:inline-block;background:#028090;color:#fff;width:1.9vw;height:1.9vw;line-height:1.9vw;
...
ul li:before{content:"·";position:absolute;left:0;color:#028090;font-weight:700}
.red{color:#B83A3A}.grn{color:#02C39A}.blu{color:#065A82}
.cite{position:absolute;bottom:2.5vh;left:5vw;font-size:1vw;color:#8899aa}
.cover .ctitle{font-size:3vw;font-weight:700;line-height:1.5}.cover .hl{color:#02C39A}
.cover .csub{font-size:1.2vw;color:#CADCFC;margin-top:3vh;line-height:1.6}
.cover .cmeta{font-size:1.3vw;margin-top:4vh}
.qbox{margin:auto 0}.qlab{font-size:1.6vw;color:#02C39A;font-weight:700;margin-bottom:3vh}
.qbig{font-size:2.4vw;font-weight:700;line-height:1.7}.qnote{font-size:1.3vw;color:#CADCFC;margin-top:4vh;line-height:1.7}
.concl-list{font-size:1.7vw;line-height:2.2;padding-left:2vw}.concl-list li{margin:1.2vh 0}.concl-list .hl2{color:#02C39A;font-weight:700}
table.fw{width:100%;border-collapse:collapse;font-size:1.4vw}
table.fw td{border:1px solid #dde3e8;padding:1.4vh 1.2vw}
table.fw .c1{font-weight:700;color:#1a2333;width:22%}.fw .c2{color:#028090;font-weight:700;width:18%}.fw .c3{color:#6b7a8d}
...
.mnum{background:#028090;color:#fff;width:2.4vw;height:2.4vw;line-height:2.4vw;text-align:center;border-radius:.5vw;font-size:1.3vw;font-weight:700;flex:none}
...
table.pa .src{color:#065A82;font-weight:700}table.pa tr:nth-child(odd){background:#eef4f7}
.concl{font-size:1.5vw;font-weight:700;margin-top:2.5vh}
.stat{text-align:center}.stat .big{font-size:7vw;color:#065A82;font-weight:800;line-height:1}.stat .cap{font-size:1.3vw;color:#6b7a8d;margin-top:1vh}
...
#bar{position:fixed;top:0;left:0;height:.5vh;background:#028090;z-index:10;transition:width .3s}
