...
WPS = [  # 距离最短:翻越两楼
    (0,0,-3),(18,0,-3),(23,0,-6.5),(30,0,-5),
    (42,0,-13.5),(46,0,-14),(52,0,-13.5),(62,0,-6),(72,0,-3),
]
...
async def main():
    ...
    np.savez(os.path.join(HERE, "px4_traj_dist.npz"), **T)
...
def _plot(T):
    ...
    plt.tight_layout()
    out = os.path.join(HERE, "px4_traj_dist.png")
